...
let NextjsWasteMgmtPlatformImages = [
    ...
    "./images/project captures/WasteR&M/Leaderboard.png",
    "./images/project captures/WasteR&M/report.png",
    "./images/project captures/WasteR&M/Reward.png",
    
];

let CNCMonitoringSystemImages = [
    
    "./images/project captures/CNCmachines/1.png",
    "./images/project captures/CNCmachines/2.png",
    "./images/project captures/CNCmachines/3.png",
    "./images/project captures/CNCmachines/4.png",
    "./images/project captures/CNCmachines/5.png",
